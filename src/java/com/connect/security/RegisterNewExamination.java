    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ExamId == null || "".equals(ExamId)) {
                UserSession.setAttribute("ExamCreationError", "Exam-ID cannot be left blank");
                response.sendRedirect("AddNewExam.jsp");
            } else if (!ExamIdStatus.contains("Available")) {
                UserSession.setAttribute("ExamCreationError", "Exam-ID is already taken");
                response.sendRedirect("AddNewExam.jsp");
            } else if (ExamName == null || "".equals(ExamName)) {
                UserSession.setAttribute("ExamCreationError", "Exam Name cannot be left blank");
                response.sendRedirect("AddNewExam.jsp");
            } else if (ExamDesc == null || "".equals(ExamDesc)) {
                UserSession.setAttribute("ExamCreationError", "Exam Description cannot be left blank");
                response.sendRedirect("AddNewExam.jsp");
            } else {
