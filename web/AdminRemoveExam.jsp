<%-- 
   ...
   Created on : 18-Apr-2015, 1:26:02 PM
   Author     : C0648301
   --%>
         ...
         <tr>
            <td align ="center">
               <form action="RemoveExam" id="RemoveExamForm" method="post">
                  <h2 style="color: #4778e3">Active Exams List</h2>
                  <%
                  ...
                  <%
                     ...
                     %>     
                  <h2 style="padding-top: 20px; color: #4778e3;">There is no Exams added at the moment</h2>
                  <h4>Add Exam into the list from the option</h4>
                  <%
                     }
                     %>
               </form>
